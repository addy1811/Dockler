...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', top: '20%', left: '15%', width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(108,99,255,0.1) 0%, transparent 70%)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: '15%', right: '10%', width: 350, height: 350, borderRadius: '50%', background: 'radial-gradient(circle, rgba(79,255,176,0.07) 0%, transparent 70%)', pointerEvents: 'none' }} />
      ...
      <div style={{
        ...
        boxShadow: '0 24px 80px var(--shadow), 0 1px 0 rgba(255,255,255,0.06) inset'
      }}>
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          <div onClick={() => navigate('/')} style={{
            display: 'inline-flex', alignItems: 'center', gap: 10, cursor: 'pointer', marginBottom: 24
          }}>
            <div style={{
            ...
            <span style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 20, color: 'var(--text)' }}>Dockler</span>
          </div>
          <h1 style={{ fontFamily: 'Syne, sans-serif', fontSize: 26, fontWeight: 800, color: 'var(--text)', marginBottom: 8 }}>Welcome back</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: 16 }}>
            <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--muted)', marginBottom: 8, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Email</label>
          ...
          <div style={{ marginBottom: 24 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
              <label style={{ fontSize: 13, fontWeight: 600, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Password</label>
              <span style={{ fontSize: 13, color: 'var(--accent2)', cursor: 'pointer' }}>Forgot?</span>
            </div>
        ...
        <p style={{ textAlign: 'center', fontSize: 14, color: 'var(--muted)', marginTop: 24 }}>
          ...
          <Link to="/signup" style={{ color: 'var(--accent2)', fontWeight: 600, textDecoration: 'none' }}>Sign up free</Link>
        </p>
      </div>
    </div>
  )
